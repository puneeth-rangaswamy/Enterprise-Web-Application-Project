...
public class ConsoleList extends HttpServlet {
	...
	//				hm.put(entry.getKey(),entry.getValue());
		...
		for(Map.Entry<String, Console> entry : hm.entrySet())
		{
			...
			pw.print("<h3 id = 'nameid"+i+"'>"+console.getName()+"</h3>");
			pw.print("<strong id = 'addid"+i+"'>"+console.getPrice()+"</strong>");
			pw.print("<h4 id = 'ratingid"+i+"'>"+console.getPrice()+"</h4><ul>");
			pw.print("<li id='item'><img id = 'imgid"+i+"' src='images/consoles/"+console.getImage()+"' alt='' /></li>");
			...
			pw.print("<table style='width:100%'>"+
				"<tr><td>Open Now?<p id = 'opennowid"+i+"'></td></tr>"+
				"</table>");
			pw.print("</ul></div></td>");
