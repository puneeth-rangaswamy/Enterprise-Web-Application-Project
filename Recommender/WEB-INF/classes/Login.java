...
public class Login extends HttpServlet {
	...
	protected void displayLogin(HttpServletRequest request,
			...
			throws ServletException, IOException {
				...
				MySqlDataStoreUtilities.readOutputFile();
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3 hidden>User Type</h3></td><td><select hidden name='usertype' class='input'><option value='customer' selected>Customer</option><option value='manager'>Store Manager</option><option value='retailer'>Salesman</option></select>"
				+ "</td></tr><tr><td></td><td>"
