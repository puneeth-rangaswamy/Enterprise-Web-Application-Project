...
public class WriteReview extends HttpServlet {
	...
	protected void review(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MongoDBDataStoreUtilities.insertRecommend(placeID);
		MySqlDataStoreUtilities.insertToTable(placeID);


      // on filling the form and clicking submit button user will be directed to submit review page
                utility.printHtml("Header.html");
		//utility.printHtml("PlaceDetails.html");
		...
		pw.print(name);
		pw.print("<input type='hidden' name='productname' value='"+placeID+"'>");
		pw.print("</td></tr>");
		pw.print("<tr><td>  <img id='googleImageReview' width='400' height='300' src ='"+ImageURL+"'/>  </td><td>");
		pw.print("<div id='map'>");
		pw.print("</td></tr>");
	        pw.print("<tr><td> Address:</td><td>");
                pw.print(address);
	        pw.print("<input type='hidden' name='producttype' value='"+address+"'>");
		pw.print("</td></tr>");
		pw.print("<tr><td> Rating:</td><td>");
                pw.print(rating);
	        pw.print("<input type='hidden' name='productprice' value='"+rating+"'>");

                pw.print("</td></tr></table>");
		
  				pw.print("</div><table><tr></tr><tr></tr><tr><td> Review Rating: </td>");
					pw.print("<td>");
